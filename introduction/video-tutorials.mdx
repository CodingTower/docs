...
description: "Watch step-by-step tutorials for building calorie trackers, CRMs, feedback tools, landing pages, and AI-powered apps with ZenOpus."
---
## Welcome to ZenOpus

<Accordion title="ZenOpus 101">
<iframe src="https://www.youtube.com/embed/l2n9rpuqvdw?si=huqUvQcNK1tKTMVL" title="YouTube video player" width="100%" height="315" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen />

<Steps>
<Step title="Getting started with ZenOpus basics">
</Step>
...
<iframe src="https://www.youtube.com/embed/c0zhLzcVJRI?si=7vcZf5eoxIobOxdE" title="YouTube video player" width="100%" height="315" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen />

This tutorial, we’ll walk you through creating an AI-powered calorie tracking app with ZenOpus, complete with authentication, a beautiful responsive design, OpenAI integration, and deployment to production.

<Steps>
<Step title="Setting Up the Foundation">
The foundation of any ZenOpus project is a good prompt. For this app, here’s an example:
...
Once ZenOpus generates the UI skeleton:
...
<Note>
Be explicit about starting with the UI. ZenOpus works best when tasks are broken into clear steps. For instance, outline navigation, page structures, and design themes early in the prompt
</Note>
</Step>
<Step title="Designing the UI">
ZenOpus emphasizes a step-by-step approach, akin to constructing a building:
...
<Note>
If you have pre-made designs in Figma, you can take screenshots and include them in your ZenOpus prompt. Providing high-resolution images ensures better results.
</Note>
</Step>
...
1. Link it to ZenOpus by pressing the “Connect Supabase” button.
1. For data storage, ZenOpus will generate SQL tables. For instance:

- A `profiles` table to store user information.
- A `meals` table linked to users for tracking daily entries.

<Note>
Use row-level security (RLS) rules in Supabase to ensure user privacy. ZenOpus can handle this for you automatically.
</Note>
</Step>
...
1. Use GPT-4 for analyzing meal descriptions or images.
1. Ensure API keys are securely stored in Edge functions to prevent unauthorized access.
...
1. Integrate Stripe with ZenOpus by adding the API key and product price ID.
1. Redirect non-paying users to the landing page. Only paying users can access the main app.
...
Errors are a natural part of development, and ZenOpus simplifies debugging:

- Use the **“Try to Fix”** button whenever a build error occurs.
- For backend issues, check Supabase logs for detailed error reports.
- If deploying to Netlify, review deployment logs for any build issues. Share logs with ZenOpus to get tailored fixes.

<Note>
If you get stuck, revert to a previous version using ZenOpus’s “Revert” feature. This saves credits and time.
</Note>
</Step>
<Step title="Deploying Your App">
Once your app is ready, deploy it with ZenOpus or Netlify:

1. Use ZenOpus’s deploy feature to host the app on a default domain.
...
<iframe src="https://www.youtube.com/embed/S0k8FOmqjog?si=935gSBuflrRbljlF" title="YouTube video player" width="100%" height="315" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen />

In this tutorial, we’ll show you how to create a stunning, fully interactive landing page for an AI-powered email assistant using ZenOpus, 21st.dev, and Supabase—complete with animations, API integrations, and seamless deployment!
...
- Deploying the page using ZenOpus Launch
</Accordion>
<Accordion title="Build a Feedback Tool">
The session showcased ZenOpus’s capabilities to iterate quickly and deliver production-ready results.

<iframe src="https://www.youtube.com/embed/tYDqBMilHkM?si=6eD-0GoQEywncOqQ" title="YouTube video player" width="100%" height="315" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen />
...
<iframe src="https://www.youtube.com/embed/eZsbfEA-_oI?si=ngagWq3q3Km1jY6J" title="YouTube video player" width="100%" height="315" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen />
...
- Built in a single prompt, showcasing ZenOpus’s efficiency.
</Step>
...
- Guiding ZenOpus’s AI with detailed prompts to ensure accurate fixes.
</Step>
</Steps>
</Accordion>
<Accordion title="Prompting Advice with ZenOpus">
<iframe src="https://www.youtube.com/embed/IqWfKj4mUIo?si=sIUpyvAuOH9Fu_oe" title="YouTube video player" width="100%" height="315" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen />

In this tutorial, we deep-dive into AI-powered app development, prompt engineering, and workflow automation with [ZenOpus](https://zenopus.dev/)’s special guest ‪[Mark Kashef‬](https://www.youtube.com/@Mark_Kashef)!
...
- Building an AI app using ZenOpus & Make.com
- Integrating Visual Edits & Tailwind CSS for UI design
</Accordion>
<Accordion title="Build a Luma Copycat with Supabase &amp; ZenOpus">
<iframe src="https://www.youtube.com/embed/-sSOyO0FiPE?si=TCamI0uASRJ2Kh6j" title="YouTube video player" width="100%" height="315" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen />

In this tutorial, we will build a Luma-style event platform using ZenOpus and [Supabase](/integrations/supabase) – live!

- How to integrate Supabase with ZenOpus
...
<iframe src="https://www.youtube.com/embed/gqsZGxuymTk?si=xwjEwFQCa5p8WVLh" title="YouTube video player" width="100%" height="315" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen />

In this tutorial, we’ll show you how to use ZenOpus, an AI-enhanced no-code builder, to create a full-stack journaling app without writing a single line of code!
...
In this tutorial, we’ll walk through creating a simple yet powerful CRM using ZenOpus for development, Supabase for data storage, and [Resend](/integrations/resend) for email automation.
...
<iframe src="https://www.youtube.com/embed/b-O7Ew0Q2ig?si=UPyQQdnualImIP8j" title="YouTube video player" width="100%" height="315" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen />

Building engaging, interactive web experiences just got easier with ZenOpus’s latest updates!

<Steps>
<Step title="Effortless UI Customization with Visual Edits">
One of the biggest upgrades to ZenOpus is the ability to modify UI elements instantly without consuming AI credits. You can now:
...
Previously, users faced challenges when dealing with third-party API integration errors. ZenOpus now:
...
<Note>
Instead of overwhelming users with generic popups, ZenOpus now feeds error context directly into its AI, which can decide when an issue needs to be addressed and how to fix it.
</Note>
</Step>
<Step title="Creating Dynamic Backgrounds and Animations">
ZenOpus now supports seamless integration of animated and interactive elements using **p5.js** and other libraries.
...
1. **A sticky-scroll section** that changes based on the user’s scroll position.
1. **Interactive hover effects** where images react to user movements.
...
<Note>
If an animation isn’t working, use ZenOpus’s Plan mode to debug and refine the effect with step-by-step AI guidance.
</Note>
</Step>
<Step title="Importing Custom Elements from External Libraries">
With **21st.dev**, users can now integrate pre-built UI components seamlessly into ZenOpus projects.

1. Browse **21st.dev** for a button design.
1. Copy the AI-generated prompt.
1. Paste it into ZenOpus and replace an existing button.
...
<iframe src="https://www.youtube.com/embed/tyAsNwu_xCI?si=VHCGf2IlFRQzVLeD" title="YouTube video player" width="100%" height="315" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen />

In this tutorial, we’ll walk through building a **custom CRM** (Customer Relationship Management system) using **ZenOpus** and **Clerk**.
</Accordion>
<Accordion title="How to Build a Custom CRM with ZenOpus and Make">
<iframe src="https://www.youtube.com/embed/zv4vcR7VCAk?si=BgJHeEuti27cbgYt" title="YouTube video player" width="100%" height="315" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen />

In this tutorial, we’ll walk through building a **custom CRM** (Customer Relationship Management system) using **ZenOpus** and **Make**.
</Accordion>
<Accordion title="Building a $10K Landing Page in 1 Hour">
<iframe src="https://www.youtube.com/embed/VVbC80KgF9E?si=71RW1V8KgpgxTya_" title="YouTube video player" width="100%" height="315" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen />
</Accordion>
</AccordionGroup>
...
<iframe src="https://www.youtube.com/embed/8QDL9cCIXqU?si=JPHSSBoWO4dXl7vB" title="YouTube video player" width="100%" height="315" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen />

<Steps>
<Step title="Laying the Foundations">
Before implementing AI features, we focused on **building a strong foundation** for the app using **ZenOpus**. This included setting up authentication, structuring the dashboard, and implementing user management.
</Step>
...
<iframe src="https://www.youtube.com/embed/eSDhk4VkVLE?si=-JhSjxsKIrPACNOK" title="YouTube video player" width="100%" height="315" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen />
...
1. ZenOpus calls an OpenAI Edge function to generate **10 engaging Spanish-language questions**.
1. Users complete quizzes, track progress, and receive AI feedback on their answers.
</Step>
...
<iframe src="https://www.youtube.com/embed/fILdgFNqvmU?si=_Xg-XTMTQuBN7bE1" title="YouTube video player" width="100%" height="315" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen />
...
Using ZenOpus, we ensured **visual consistency** across the app:
...
<iframe src="https://www.youtube.com/embed/12013xnxYzM?si=4qOqTgcgO_IY_G1P" title="YouTube video player" width="100%" height="315" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen />
</Accordion>
</AccordionGroup>

## Community tutorials

Check out the ZenOpus Community tutorials [here](https://www.youtube.com/playlist?list=PLbVHz4urQBZkJ6WMXlIGc3NGsufrleogY).
