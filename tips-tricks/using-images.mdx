---
title: "Using images in ZenOpus"
description: "Upload images to chat, replace them with visual edits, use external URLs, or add files from your GitHub public directory."
---
To add images you can do one of four things:

<AccordionGroup>
<Accordion title="Upload the image to the prompt chat">
Simply upload them in the chat and explain to ZenOpus’s Agent where and how you’d like them to appear in your project. For example:

> Replace the logo in navbar with this image
</Accordion>
<Accordion title="Replace it on the visual editor">
You can replace an existing image directly using the [visual editor](/features/design) functionality:
...
![Visual editor showing an image element selected with the edit panel open](/images/zenopus/tips-tricks/using-images/visual-edit-replace.png)
</Step>
<Step title="Step 3">
Change the image.

![Image replacement dialog in visual editor with upload and URL options](/images/zenopus/tips-tricks/using-images/visual-edit-image.png)
</Step>
</Steps>
</Accordion>
...
Here’s how to prompt ZenOpus to use an external image:
...
<Step title="Step 2">
In your project prompt, simply tell ZenOpus to use that image by specifying the URL. For example:
...
Another method to add images to your ZenOpus project is by using images uploaded to the `public` directory of your connected GitHub repository. Here’s how you can do it:

<Steps>
<Step title="Connect your GitHub repository">
Ensure your project is connected to your GitHub repo. [Here’s how to connect your repo](/integrations/git-integration).
</Step>
...
<Step title="Add file">
Click on **Add file** and then from a dropdown, select **Upload files** option. ![Selecting files for upload](/images/zenopus/tips-tricks/using-images/using-images-github-upload.png)
</Step>
...
- Click on the **“choose your files”** link to browse and select the image file.
    ![Selecting files for upload](/images/zenopus/tips-tricks/using-images/using-images-github-commiting.png)
</Step>
...
Once the file is uploaded, select it and then click on the copy icon next to the file name to copy the image’s path. This path will be used in your ZenOpus prompt. ![Selecting files for upload](/images/zenopus/tips-tricks/using-images/using-images-github-selecting.png)
</Step>
<Step title="Use the image in ZenOpus">
...
<Warning>
Uploading large images to your GitHub repo can cause it to grow in size, which can affect ZenOpus performance (longer repo cloning times, slower startup of previews/sandbox).
...
To help you better understand how to integrate images using the methods outlined above, we have a project you can explore: [ZenOpus Project Example](https://zenopus.dev/projects/e823fedf-238d-4313-86a8-1fd4bfc2a9ba). In this project, you can see the actual prompts and how each method works in practice.
