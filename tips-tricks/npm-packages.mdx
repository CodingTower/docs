...
description: "Add drag-and-drop, charts, animations, and other advanced features by integrating npm packages into your projects."
---
While ZenOpus is powerful on its own, enabling users to build sophisticated web applications, you can leverage npm packages for more advanced and extended features. These packages help you build even more complex and feature-rich applications with ease.
...
Let’s say you’d like to create a tool that enables you to arrange your tasks in different Kanban boards, similar to many popular project management tools. You can prompt ZenOpus to build this tool from scratch, but it might be slower and more challenging to achieve the desired functionality.
...
This prompt directs ZenOpus to integrate the package into your project, making it easier to achieve the desired functionality. Depending on other requirements, your result might look somewhat like this.

![ZenOpus implemented drag-and-drop Kanban functionality](/images/zenopus/tips-tricks/npm-packages/npm-example-using-pangea-dnd.png)

## Quality and responsibility

It’s important to note that while npm packages can significantly enhance your projects, ZenOpus cannot guarantee the quality or reliability of these third-party packages.
