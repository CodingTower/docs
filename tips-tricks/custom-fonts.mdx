...
description: "Apply web-safe fonts like Arial or Courier New, or import Google Fonts by name or URL to customize your project's typography."
---
Currently, ZenOpus does not support direct uploads of custom fonts.
...
If you prefer to use custom fonts, ZenOpus works nicely with **Google Fonts**. This allows you to easily use a wide range of fonts in your project. You can either reference a Google font by name or by linking directly to the font resource.

### Using by name

In your prompt, you can specify the name of a Google font, and ZenOpus will include it in your project. For example:
...
Alternatively, you can provide a direct link to the Google font, and ZenOpus will use that font in your project. You can get the link from [Google Fonts](https://fonts.google.com) by selecting the desired font and copying the link.

Here’s how to prompt ZenOpus to use a Google font via a link:
...
By following these methods, you can customize the typography of your ZenOpus project using either web-safe fonts or Google Fonts.

## Further learning and examples

To see these font integration methods in action, you can explore one of our example projects: [ZenOpus using fonts example project](https://zenopus.dev/projects/3a826f38-d9cb-4d60-b4da-30a9b00149c8).
...
![Different fonts used in ZenOpus project](/images/zenopus/tips-tricks/custom-fonts/using-custom-fonts-example.png)
