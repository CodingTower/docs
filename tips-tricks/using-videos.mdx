---
title: "Using videos"
description: "Embed YouTube videos or upload video files to your GitHub repository and reference them in your ZenOpus projects."
---
ZenOpus offers two methods for embedding videos into your projects. Below, we’ll cover both options step by step:
...
<Warning>
Uploading large videos to your GitHub repo can cause it to grow in size, which can affect ZenOpus performance (longer repo cloning times, slower startup of previews/sandbox).
...
First, make sure your project is linked to a GitHub repo. [Here’s how to set up your repo](/integrations/git-integration).
</Step>
...
After selecting your video file, enter a brief commit message (e.g., “Adds a Mars video to be used in the app”) and click **“Commit changes”**. ![Committing video file](/images/zenopus/tips-tricks/using-videos/using-videos-github-commiting.png)
</Step>
<Step title="Get the video path">
Once the upload is complete, click on the video file and use the copy icon  :octicons-copy-16:  to copy its path. You’ll need this path in the next step. ![Copy video file path](/images/zenopus/tips-tricks/using-videos/using-videos-github-selecting.png)
</Step>
<Step title="Reference the video in ZenOpus">
...
To see these methods in action, explore one of the example projects: [ZenOpus using videos example project](https://zenopus.dev/projects/380835ab-c8d7-4f45-9b0d-51ec04294457). You’ll find real prompts demonstrating how videos are integrated using both methods.
