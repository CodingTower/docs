...
description: "Reuse ZenOpus projects as design templates. Templates copy the full codebase, including design, components, and structure, to maintain consistency and accelerate development."
---
...
A design template is a ZenOpus project that has been marked as reusable. When a template is used, the entire project codebase is copied into the new project, including:
...
1. Set the project visibility to **public** or **workspace.**
1. Enable **Use as a template.**
...
1. Go to **Design → Use a template**.
1. Choose a template and create your project as usual.
...
1. Hover over a template and select **Set as default**.
...
1. Go to **Workspace settings → Templates**.
1. Hover over the template and remove the default.
