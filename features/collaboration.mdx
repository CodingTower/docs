---
title: "Collaboration"
description: "Invite teammates to projects or workspaces, assign roles and permissions, and see changes in real time as you build together."
---
ZenOpus lets you build websites together. Invite your designer, developer, agency, or anyone else. Everyone sees changes as they happen.
...
| Remove ZenOpus badge | No | Yes | Yes | Yes |
...
Yes! Go to the main dashboard. From there press your workspace name in the top left corner. In the dropdown you’ll see the other workspaces you have access to. To switch, simply click the desired workspace.
</Accordion>
